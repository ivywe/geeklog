...
// Geeklog Custom - https://pear.php.net/package/XML_RPC
// This is version 1.5.5 released on 2011-08-27 but customized to support PHP 7
...
// Geeklog Custom Code to deal with each being depreciated by PHP 7.2
function myEach(&$arr) {
    $key = key($arr);
