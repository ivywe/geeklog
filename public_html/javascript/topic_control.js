...
var onTopicChange = function () {
    ...
    var options_inherited = $('#tid option:selected').sort().clone();
    var options_inherited_not_selected = $('#inherit_tid option:not(:selected)').sort().clone();
    ...
    var options_default = $('#tid option:selected').sort().clone();
    ...
    var select_default_tid = $('#default_tid');
