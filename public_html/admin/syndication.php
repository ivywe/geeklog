...
if ($_CONF['backend'] && isset($_POST['feedenabler']) && SEC_checkToken()) {
    $enabledfeeds = Geeklog\Input::post('enabledfeeds', array());
    $visiblefeeds = Geeklog\Input::post('visiblefeeds', array());
