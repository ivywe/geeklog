...
$PLG_links_MESSAGE1 = "{$_CONF['site_name']}にリンクを登録していただき、ありがとうございます。このリンクはスタッフよる承認待ちとなっています。承認が済むと、このサイトの<a href={$_CONF['site_url']}/links/index.php>リンクセクション</a>にリンクを表示します。";
$PLG_links_MESSAGE2 = 'リンクを保存しました。';
$PLG_links_MESSAGE3 = 'リンクを削除しました。';
...
$PLG_links_MESSAGE6 = 'あなたには、このカテゴリを編集する十分な権限がありません。';
$PLG_links_MESSAGE7 = 'カテゴリの名前と説明を入力してください。';
$PLG_links_MESSAGE10 = 'カテゴリを保存しました。';
$PLG_links_MESSAGE11 = 'カテゴリ IDを「site」または「user」に設定することはできません。これらは内部で使用するために予約しています。';
...
$PLG_links_MESSAGE13 = 'カテゴリを削除しました。';
...
$PLG_links_MESSAGE17 = 'このカテゴリIDは既に使われています。';

// Messages for the plugin upgrade
$PLG_links_MESSAGE3001 = 'プラグインはアップグレードをサポートしていません。';
...
$LANG_LINKS_ADMIN = array(
    ...
    11 => 'リンク管理',
    12 => 'リンクを編集や削除するには以下のアイコンをクリックしてください。新しいリンクを追加するには、上の「新規リンク作成」または「カテゴリ新規作成」をクリックしてください。 複数のカテゴリを編集するには、上の「カテゴリの「カテゴリのリスト」をクリックしてください。',
    14 => 'カテゴリ',
    16 => 'アクセスできません',
    ...
    43 => 'サイトカテゴリ',
    44 => '子カテゴリの追加',
    46 => 'ユーザー %s は、アクセス権がないカテゴリを削除しようとしました。',
    50 => 'カテゴリのリスト',
    51 => 'リンクの作成',
    52 => 'カテゴリの作成',
    53 => 'リンクのリスト',
